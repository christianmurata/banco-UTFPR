...
/*
*Prototipo da fun��o do menu do funcionario
*/

void menu();

/*
*Prototipo da fun��o que realiza a limpeza de tela
*/
...
/*
* Prototipo da fun��o que retorna o numero da proxima
...
/*
* Prototipo da fun��o do que reliza o deposito de uma conta
...
/*
* Prototipo da fun��o do que reliza o saque de uma conta
* bancaria se tendo o numero desta conta
*/
...
void saqueCCorrente(int nconta,RegCCorrentePtr* Ptrinicial, double saque)
{
        ...
        //if(Contadestino->depositoInicial=='C'&&Contadestino->depositoInicial<0) O saque pra conta espcial e comum funciona diferente, n�o implementei ainda
        //{printf()}
